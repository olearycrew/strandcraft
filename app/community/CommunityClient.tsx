...
export default function CommunityClient() {
    ...
    const fetchPuzzles = async () => {
        try {
            const response = await fetch('/api/puzzles/recent');
            ...
            <main className="min-h-screen bg-gray-900 text-white">
                <div className="max-w-6xl mx-auto px-4 py-8">
                    ...
                    <div className="text-center py-16">
                        ...
                        <h2 className="text-2xl font-bold mb-2">Loading puzzles...</h2>
                        <p className="text-gray-400">
                            Please wait while we fetch the latest puzzles
                        </p>
                    </div>
                </div>
            </main>
            ...
            <main className="min-h-screen bg-gray-900 text-white">
                <div className="max-w-6xl mx-auto px-4 py-8">
                    ...
                    <div className="text-center py-16">
                        ...
                        <h2 className="text-2xl font-bold mb-2">Failed to load puzzles</h2>
